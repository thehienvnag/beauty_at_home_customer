...
List<ServiceItem> lstService = List.from([
  ServiceItem(titleService: '90 phút massage body toàn thân', price: '200.000',image: 'public/img/beautician1.png'),
  ServiceItem(titleService: '60 phút massage body toàn thân', price: '150.000',image: 'public/img/beautician2.png'),
  ServiceItem(titleService: '30 phút massage body toàn thân', price: '100.000',image: 'public/img/beautician3.png'),
  ServiceItem(titleService: '10 phút massage body toàn thân', price: '80.000',image: 'public/img/logo.png'),
]);
                  ...
                  Row(
                      children: [
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  Text(' ${itemList[index].price}', style: TextStyle(color: Colors.black,),
                                  ),
                                ],
                              ),
                            ],
                        ...
                        Container(
                          ...
                          width: 50,
                          height: 50,
                          child: Image(image: AssetImage(itemList[index].image,),fit: BoxFit.cover,),
                        ),
                      ],
                    ), SizedBox(height: 5,),
                  Container(width: size.width, height: 1, color: Colors.black.withOpacity(0.2)),
